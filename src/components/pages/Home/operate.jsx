  ...
  return (
    <div className='mb-10'>
      <div className="bg-[#4B9569] text-white py-5 mb-10">
        <h1 className='text-center text-3xl font-bold mb-5'>How we Operate</h1>

        <div className="flex items-center w-[70%] mx-auto gap-20">
          <img src={Img2} className='w-[40%]' />

          <div className='w-[50%]'>
            <h1 className="font-bold text-4xl pb-5">Get Matched with professional therapist</h1>
      ...
      <div className="flex items-center w-[50%] mx-auto gap-20 mb-20">
        ...
        <img src={Health} className='w-[40%] rounded-sm h-52' />
      </div>
      ...
      <div className="flex items-center w-[50%] mx-auto gap-20">
        ...
        <img src={Hand}  className='w-[90%] h-52 rounded-sm' />
      </div>
