      ...
      <div>
        <div className='py-[6rem] pl-10 image pt-52 w-full'>
          <div className='w-[30%] space-y-4 text-white'>
            ...
            <button className='bg-[#FFC107] px-4 py-2 text-white rounded-sm'>Learn more</button>
          </div>
        </div>
        ...
        <div className='flex items-center py-5 w-[50%] mx-auto gap-10'>
          <div className='flex flex-col gap-5'>
            ...
            <button className='bg-gradient-to-b from-[#FFC107] to-[#4B9569] px-4 py-2 text-white rounded-sm w-[32%]'>Get Started</button>
          </div>
